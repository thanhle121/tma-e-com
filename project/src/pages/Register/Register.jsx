    ...
    return (
        <div className={styles.registerContainer}>
            <div className={styles.registerLeft}>
                <img className={styles.imgRegister} src={siginImg} alt="" />
            </div>
            <div className={styles.registerRight}>
                ...
                <div className={styles.formContainer}>
                    <form className={styles.registerForm} onSubmit={handleSubmit}>
                        ...
                        <p style={{ display: validEmail, color: 'red' }}>
                            Email đã được dùng, hãy chọn email khác.
                        </p>
                        <p style={{ display: validPassword, color: 'red' }}>
                        ...
                        <p>
                            Đã có tài khoản?{" "}
                            <a className={styles.registNow} href="/signin">
                                Đăng nhập ngay
                            </a>
                        </p>
